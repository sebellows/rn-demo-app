...
type RestyleProps = AllProps<Theme> & VariantProps<Theme, 'buttonVariants'>
...
const ButtonBase = createRestyleComponent<RestyleProps, Theme>(
...
// import { hasTouchHandler } from '../utils'
